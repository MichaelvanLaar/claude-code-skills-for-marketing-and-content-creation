...
> (Examples: linkedin-post, other skills you may have invoked.
...
Determine the skill's format guidelines path. For `linkedin-post`, that is
`.claude/skills/linkedin-post/format-guidelines.md`. For other skills, look
for a `format-guidelines.md` inside `.claude/skills/<skill-name>/`.
